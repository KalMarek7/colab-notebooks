...
* **Results:** A summary of the evaluation can be found in `results.txt` and `vram_usage.txt`.
* **Data:** All source files and data used for the tests are archived in `files.7z`.
